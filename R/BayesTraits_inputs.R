#' Produces BayesTraits linked input data
#'
#' @author Domingos Cardoso & Matt Lavin
#'
#' @description It produces all BayesTraits input data of linked samples of trait/climate
#' data (distribution data) for phylogenetic regression analyses with Meade & Pagel's (2022) [BayesTraits](http://www.evolution.reading.ac.uk/BayesTraitsV4.0.0/BayesTraitsV4.0.0.html)
...
#' been successfully used to explore the effect of speciation rates (e.g. [O’Donovan et al. 2018](https://doi.org/10.1038/s41559-017-0454-6))
#' on the response variable. See [BayesTraits V4.0.0 Manual](http://www.evolution.reading.ac.uk/BayesTraitsV4.0.0/Files/BayesTraitsV4.0.0-Manual.pdf)
...
#'
#' @param data The input sample of trait (distribution) data in data.frame format.
...
#'
#' @param tipscol Give the name of the column with terminals/tip labels within
...
#'
#' @param logtransf A vector with the name of the column(s) of the trait data to
...
#'
#' @param sqrtransf A vector with the name of the column(s) of trait data to be
...
#'
#' @param traitcols A vector with the name of the column(s) of the input
...
#'
#' @param ordtraits A vector listing the order of trait names to be used in
...
#'
#' @param dir_create Pathway to the computer's directory where the file will be saved. The
#' default setting creates a directory named **results_BayesTraits_input** and the
#' results will be saved within a subfolder of that directory named with the current date.
#'
#' @param fileDistData Name of the resulting .txt file of linked samples of trait
#' data. If no name is given, the default setting creates a file named *BayesTraits_linked_input.txt*.
#'
#' @param fileMeanData Name of the resulting .txt file of mean trait data. If
#' no name is given, the default setting creates a file named *BayesTraits_mean_input.txt*.
#'
#' @param fileOrigData If you define any name here, the originally imported trait
