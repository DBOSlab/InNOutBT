...
#'
#' @description This function produces BayesTraits input data that comprises samples
#' of trait/climate data (distribution data) for phylogenetic regression analyses
#' with Meade & Pagel's (2022) [BayesTraits](http://www.evolution.reading.ac.uk/BayesTraitsV4.0.0/BayesTraitsV4.0.0.html)
...
#' branch label of the input phylogeny (i.e., each species or accession).
#'
...
#'
#' @param NodeCount Logical, if \code{TRUE}, the function will create
...
#' for every accession of each terminal label in the linked samples of trait data.
#'
#' @param logtransf A vector with the name of the column(s) in the original trait data
...
#' analysis, list them as argument in \code{addtraits} (see below).
#'
#' @param sqrtransf A vector with the name of the column(s) in the original trait data
