...
#' imported by \code{ape}'s function \link[ape]{read.tree} or a treedata-formatted
#' phylogeny as generated by [BEAST](https://beast.community) and read by
#' \code{treeio}'s function \link[treeio]{read.beast}.
#'
...
phyreg.inputs <- function(tree,
  ...
  utils::write.table(linkedinputdata,
                     file = fulldistname,
                     quote = FALSE,
                     row.names = FALSE,
                     col.names = FALSE)
  ...
  utils::write.table(meaninputdata,
                     file = fullmeanname,
                     quote = FALSE,
                     row.names = FALSE,
                     col.names = FALSE,
