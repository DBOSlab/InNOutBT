...
$PROJECTFOLDER="C:\Users\Matt_\Documents\BayesTraits_shell_run_project"
...
Invoke-Expression "$RFOLDER .\1_producing_BayesTraits_inputs.R"


## Producing BayesTraits shell script
Invoke-Expression "$RFOLDER .\2_producing_BayesTraits_shell.R"
...
Unblock-File -Path .\run_BayesTraits_shell_windows.ps1
.\run_BayesTraits_shell_windows.ps1


## Moving the resulting outputs into the main project folder
Move-Item -Path BayesTraits_outputs_log_stone -Destination $PROJECTFOLDER
Move-Item -Path BayesTraits_outputs_sch_trees -Destination $PROJECTFOLDER


## Processing BayesTraits output
cd $PROJECTFOLDER
Invoke-Expression "$RFOLDER .\3_processing_BayesTraits_outputs.R"
...
Invoke-Expression "$ACROBATFOLDER Bayes_Factor_heatmap_cluster.pdf"
Invoke-Expression "$ACROBATFOLDER Bayes_Factor_heatmap.pdf"
Invoke-Expression "$WORDFOLDER BayesTraits_output_table.docx"
